...
<head>
    ...
    <style>
        * {
        ...
        /* AJOUTER : Style pour la colonne organisateur */
        .organizer-name {
        ...
        /* AJOUTER : Style pour les événements premium */
        .premium-event {
            background: linear-gradient(90deg, rgba(189, 0, 255, 0.05), transparent);
            border-left: 3px solid var(--secondary-purple);
        }

        .premium-event td:first-child::before {
            content: "⭐ ";
            color: var(--secondary-purple);
        }
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="stats-container">
            ...
            <div class="stat-card">
                <div class="stat-number"><?php echo $freeEvents; ?></div>
        ...
        <div class="page-header">
            ...
            <a href="evenements/create.php" class="btn-primary">NOUVEL ÉVÉNEMENT</a>
        </div>
                ...
                <table>
                    <thead>
                        <tr>
                            <th>NOM</th>
                            <th>JEU</th>
                            <th>ORGANISATEUR</th> <!-- AJOUTER CETTE COLONNE -->
                            <th>DATE DÉBUT</th>
                            <th>DATE FIN</th>
                            <th>LIEU</th>
                            <th>PLACES</th>
                    ...
                    <tbody>
                        <?php foreach($evenements as $evenement): 
                            $participationsCount = $evenementController->show($evenement['id_evenement'])->countParticipations();
                            $placesClass = '';
                            if ($participationsCount >= $evenement['places_max']) {
                                $placesClass = 'places-full';
                            } elseif ($participationsCount >= $evenement['places_max'] * 0.8) {
                                $placesClass = 'places-warning';
                            } else {
                                $placesClass = 'places-available';
                            }
                            
                            // Déterminer si c'est un événement premium
                            $isPremium = $evenement['prix'] > 0;
                            $rowClass = $isPremium ? 'premium-event' : '';
                        ?>
                        <tr class="<?php echo $rowClass; ?>">
                            <td><strong><?php echo htmlspecialchars($evenement['nom']); ?></strong></td>
                            <td><?php echo htmlspecialchars($evenement['jeu']); ?></td>
