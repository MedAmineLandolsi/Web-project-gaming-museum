    ...
    <div class="main-content">
        ...
        <div class="edit-container">
            <div class="page-header">
                ...
                <div class="page-subtitle">Modifiez les informations de l'événement existant</div>
                <div class="event-id">ID: #<?php echo htmlspecialchars($_GET['id']); ?></div>
            </div>
            ...
            <div class="organizer-info">
                👤 Cet événement est organisé par : <strong><?php echo htmlspecialchars($evenement->organisateur_nom ?? 'Admin'); ?></strong>
                <br>
                <small style="color: var(--text-gray); font-size: 0.5rem;">
                    Vous pouvez modifier cet événement car <?php echo ($_SESSION['role'] == 'admin') ? 'vous êtes administrateur' : 'vous en êtes l\'organisateur'; ?>
                </small>
            </div>
            ...
            <div class="event-info">
                <div class="info-item">
                    ...
                    <div class="info-value"><?php echo isset($evenement->created_at) ? date('d/m/Y', strtotime($evenement->created_at)) : 'N/A'; ?></div>
                </div>
                <div class="info-item">
                    <div class="info-label">DERNIÈRE MODIFICATION</div>
                    <div class="info-value"><?php echo isset($evenement->updated_at) ? date('d/m/Y', strtotime($evenement->updated_at)) : 'N/A'; ?></div>
                </div>
                <div class="info-item">
                    <div class="info-label">PLACES RESTANTES</div>
                    <div class="info-value" style="color: var(--secondary-purple)">
                        <?php 
                        $participationsCount = $evenement->countParticipations();
                        echo ($evenement->places_max - $participationsCount) . ' / ' . $evenement->places_max; 
                        ?>
                    </div>
                </div>
                <div class="info-item">
                    <div class="info-label">INSCRITS</div>
                    <div class="info-value" style="color: var(--accent-pink)">
                        <?php echo $participationsCount; ?> participants
                    </div>
                </div>
            </div>
            ...
            <div class="form-container">
                <form method="POST" id="editEventForm" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" name="description" class="form-control" rows="4"><?php echo htmlspecialchars($evenement->description); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="jeu" name="jeu" class="form-control" 
                               value="<?php echo htmlspecialchars($evenement->jeu); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="lieu" name="lieu" class="form-control" 
                               value="<?php echo htmlspecialchars($evenement->lieu); ?>" required>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="places_max" name="places_max" class="form-control" 
                                   value="<?php echo $evenement->places_max; ?>" min="1" max="1000" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="prix" name="prix" class="form-control" 
                                   value="<?php echo $evenement->prix; ?>" step="0.01" min="0" max="10000">
                            <span class="error-message" id="prix_error"></span>
                            <div class="form-hint">Gratuit si 0€</div>
                        </div>
                    </div>
                    
                    <!-- AJOUTER : Champ pour l'image -->
                    <div class="form-group">
                        <label for="image">IMAGE DE L'ÉVÉNEMENT</label>
                        <?php if (!empty($evenement->image)): ?>
                            <div class="image-preview" id="currentImage">
                                <img src="../../uploads/<?php echo htmlspecialchars($evenement->image); ?>" alt="Image actuelle">
                                <p style="margin-top: 0.5rem; font-size: 0.6rem; color: var(--text-gray);">
                                    Image actuelle
                                </p>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="image-preview" id="imagePreview">
                            <!-- L'aperçu de la nouvelle image apparaîtra ici -->
                        </div>
                    </div>
                    
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" id="submitBtn">MODIFIER L'ÉVÉNEMENT</button>
