...
<head>
    ...
    <style>
        * {
        ...
        /* AJOUTER : Info sur l'organisateur */
        .organizer-info {
            background: rgba(0, 255, 65, 0.1);
    ...
    <div class="main-content">
        ...
        <div class="create-container">
            <div class="page-header">
                ...
                <div class="page-subtitle">Remplissez les informations pour créer un nouvel événement gaming</div>
            </div>
            ...
            <div class="form-container">
                <form method="POST" id="createEventForm" enctype="multipart/form-data" novalidate>
                    <!-- AJOUTER : Champ caché pour l'organisateur -->
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" id="places_max" name="places_max" class="form-control" 
                                   placeholder="50" value="50" min="1" max="1000" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="prix" name="prix" class="form-control" 
                                   step="0.01" value="0" placeholder="0.00" min="0" max="10000">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary" id="submitBtn">CRÉER L'ÉVÉNEMENT</button>
