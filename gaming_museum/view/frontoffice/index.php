...
// Workspace base (ex: /projet-web) so links to other modules work.
$scriptName = str_replace('\\', '/', $_SERVER['SCRIPT_NAME'] ?? '');
$rootBase = rtrim(dirname($scriptName, 4), '/');
if ($rootBase === '.' || $rootBase === '/') {
    $rootBase = '';
}
$communautesUrl = $rootBase . '/projet/';
$articlesUrl = $rootBase . '/projetweb12/views/Frontoffice/index.php';
$gamesUrl = $rootBase . '/Crud-Jeux/view/frontoffice/index.php';
$eventsUrl = $rootBase . '/projet_gaming/index.php';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
...
<body>
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-left">
                <a class="logo-container" href="/projet-web/gaming_museum/view/frontoffice/index.php" style="text-decoration:none; color:inherit;">
            ...
            <div class="nav-center">
                <ul class="nav-menu">
                    <li><a href="/projet-web/gaming_museum/view/frontoffice/index.php" class="active">HOME</a></li>
                    <li><a href="<?php echo htmlspecialchars($gamesUrl); ?>">JEUX</a></li>
                    <li><a href="<?php echo htmlspecialchars($articlesUrl); ?>">article</a></li>
                    <li><a href="<?php echo htmlspecialchars($eventsUrl); ?>">EVENTS</a></li>
                    <li><a href="/projet-web/ProjetWeb/index.php?action=front">RECLAMATION</a></li>
                    <li><a href="<?php echo htmlspecialchars($communautesUrl); ?>">COMMUNAUTES</a></li>
                </ul>
            </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        <li><a href="/projet-web/gaming_museum/view/frontoffice/index.php">► Accueil</a></li>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="/projet-web/ProjetWeb/index.php?action=front">► Support & Reclamations</a></li>
                        <li><a href="#">► FAQ</a></li>
                    </ul>
                </div>
