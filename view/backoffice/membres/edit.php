<div class="card">
    ...
    <div class="card-body">
        <form action="/projet/admin/membres/<?php echo $this->membreModel->id; ?>/edit" method="POST" data-validate="true">
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['form_errors']['prenom']) ? 'is-invalid' : ''; ?>" 
                            ...
                            value="<?php echo $_SESSION['old_input']['prenom'] ?? $this->membreModel->prenom; ?>" data-required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['form_errors']['nom']) ? 'is-invalid' : ''; ?>" 
                               id="nom" name="nom" 
                            value="<?php echo $_SESSION['old_input']['nom'] ?? $this->membreModel->nom; ?>" data-required>
            ...
            <div class="mb-3">
                <label for="email" class="form-label">Email *</label>
                  <input type="email" class="form-control <?php echo isset($_SESSION['form_errors']['email']) ? 'is-invalid' : ''; ?>" 
                      id="email" name="email" 
                      value="<?php echo $_SESSION['old_input']['email'] ?? $this->membreModel->email; ?>" data-required>
            ...
            <div class="mb-3">
                ...
                <select class="form-control <?php echo isset($_SESSION['form_errors']['statut']) ? 'is-invalid' : ''; ?>" 
                        id="statut" name="statut" data-required>
