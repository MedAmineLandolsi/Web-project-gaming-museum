        ...
        <form action="/projet/admin/communautes/<?php echo $this->communauteModel->id; ?>/edit" method="POST" data-validate="true">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['form_errors']['nom']) ? 'is-invalid' : ''; ?>" 
                               id="nom" name="nom" 
                               value="<?php echo $_SESSION['old_input']['nom'] ?? $this->communauteModel->nom; ?>" data-required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['form_errors']['categorie']) ? 'is-invalid' : ''; ?>" 
                               ...
                               value="<?php echo $_SESSION['old_input']['categorie'] ?? $this->communauteModel->categorie; ?>" data-required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control <?php echo isset($_SESSION['form_errors']['description']) ? 'is-invalid' : ''; ?>" 
                          id="description" name="description" rows="3" data-required><?php echo $_SESSION['old_input']['description'] ?? $this->communauteModel->description; ?></textarea>
