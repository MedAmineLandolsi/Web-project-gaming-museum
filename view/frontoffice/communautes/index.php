            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex gap-2">
                    <select class="form-select form-select-sm" id="sortOrder" onchange="updateSort()">
                        ...
                        <option value="nom_desc" <?php echo ($_GET['order_by'] ?? '') == 'nom' && ($_GET['order_dir'] ?? '') == 'DESC' ? 'selected' : ''; ?>>Nom (Z-A)</option>
                        <option value="categorie_asc" <?php echo ($_GET['order_by'] ?? '') == 'categorie' && ($_GET['order_dir'] ?? '') == 'ASC' ? 'selected' : ''; ?>>Catégorie (A-Z)</option>
                    </select>
                </div>
            </div>
        </div>
