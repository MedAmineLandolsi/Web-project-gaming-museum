                        ...
                        <div class="card-body py-2">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="btn-group btn-group-sm d-flex flex-wrap gap-3">
                                    <a href="<?php echo (defined('BASE_URL') ? BASE_URL : '/projet'); ?>/communautes/<?php echo $communaute['id']; ?>" class="btn btn-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    joinButtons.forEach(button => {
        button.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('<?php echo (defined('BASE_URL') ? BASE_URL : "/projet"); ?>/api/join-community', {
                    method: 'POST',
                    headers: {
    ...
    quitButtons.forEach(button => {
        button.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch('<?php echo (defined('BASE_URL') ? BASE_URL : "/projet"); ?>/api/leave-community', {
                    method: 'POST',
