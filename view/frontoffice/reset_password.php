...
require_once __DIR__ . '/../../controller/password_reset_controller.php';

try {
    $controller = new PasswordResetController();
    $tokenValid = $controller->verifyToken($token);

    if (!$tokenValid['success']) {
        $errorMessage = $tokenValid['message'];
    }
} catch (Exception $e) {
...
<head>
    ...
    <title>Reset Password - Ludology Vault</title>
                ...
                <div class="card-single">
                    <div class="center-wrap">
                        <div class="section text-center">
                            <h3 class="form-title">REINITIALISATION</h3>
                            <?php if (isset($errorMessage)): ?>
                                <div class="warning-message" style="display: block;">
                                    <?php echo htmlspecialchars($errorMessage); ?>
                                    <br><br>
                                    <a href="forgot_password.php" class="link">Demander un nouveau lien &gt;</a>
                                </div>
                            <?php else: ?>
                                ...
                                <form id="resetPasswordForm">
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-style" placeholder="Nouveau mot de passe" id="password" autocomplete="off" required>
                                    ...
                                    <div class="form-group mt-2">
                                        <input type="password" name="confirm_password" class="form-style" placeholder="Confirmer le mot de passe" id="confirmPassword" autocomplete="off" required>
                                        <i class="input-icon uil uil-lock-alt"></i>
                                        <span class="error-message"></span>
                                    </div>
                                    <button type="submit" class="btn mt-4"><span>RÉINITIALISER</span></button>
        ...
        if (passwordInput) {
            ...
            passwordInput.addEventListener('blur', function() {
                ...
                if (!password) {
                    ...
                    showError(this, 'Le mot de passe doit contenir au moins 8 caractères avec majuscule, minuscule, chiffre et caractère spécial');
                } else {
                    clearError(this);
                }
            });
        ...
        if (resetForm) {
            resetForm.addEventListener('submit', function(e) {
                ...
                if (!password) {
                    ...
                    showError(passwordInput, 'Le mot de passe doit contenir au moins 8 caractères avec majuscule, minuscule, chiffre et caractère spécial');
                    isValid = false;
                } else {
                ...
                if (isValid) {
                    ...
                    .then(data => {
                        if (data.success) {
                            showSuccess(data.message + ' Redirection vers la page de connexion...');
                        } else {
                            alert(data.message);
                        }
                    })
