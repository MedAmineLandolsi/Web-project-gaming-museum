...
// Récupérer les informations de l'utilisateur connecté si nécessaire
if (isset($_SESSION['user_id']) && (!isset($_SESSION['user_first_name']) || !isset($_SESSION['user_last_name']))) {
    // Récupérer les informations utilisateur depuis la base de données
    $query = "SELECT first_name, last_name, username FROM users WHERE id = ?";
...
<body>
                ...
                <div class="current-user">
                    ...
                    <?php 
                        if (isset($_SESSION['user_first_name']) && isset($_SESSION['user_last_name'])) {
                            ...
                            echo "Utilisateur #" . htmlspecialchars($_SESSION['user_id']);
                        }
                    ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (navDropdown) {
                // Sur une page d'article unique, on sélectionne "ARTICLES"
