...
// CORRECTION : Récupérer le nom d'utilisateur de manière sécurisée
$nom_utilisateur = 'Utilisateur';
if (isset($_SESSION['username'])) {
    $nom_utilisateur = $_SESSION['username'];
} elseif (isset($_SESSION['first_name'])) {
    $nom_utilisateur = $_SESSION['first_name'];
    if (isset($_SESSION['last_name']) && !empty($_SESSION['last_name'])) {
        $nom_utilisateur .= ' ' . $_SESSION['last_name'];
    }
}
                ...
                <div class="nav-dropdown-container">
                    <select class="nav-dropdown" onchange="if(this.value) window.location.href=this.value">
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <option value="mes-articles.php" selected>📁 MES ARTICLES</option>
    ...
    <section class="mes-articles-section">
        <div class="container">
            ...
            <div class="user-welcome">
                <!-- CORRECTION : Utiliser la variable $nom_utilisateur sécurisée -->
                <strong>Bienvenue <?php echo htmlspecialchars($nom_utilisateur); ?> !</strong><br>
                    ...
                    <div class="article-card">
                        ...
                        <div class="article-content">
                            ...
                            <div class="article-meta">
                                ...
                                <!-- CORRECTION : Utiliser la variable $nom_utilisateur -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (navDropdown) {
                ...
                // S'assurer que "MES ARTICLES" est sélectionné sur cette page
                if (currentPage === 'mes-articles.php') {
                    navDropdown.value = 'mes-articles.php';
                }
