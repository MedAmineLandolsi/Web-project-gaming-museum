...
<nav class="navbar">
    ...
    <section class="events-section">
        ...
        <div class="events-grid">
            <?php foreach(array_slice($evenements, 0, 3) as $evenement): 
                // AJOUTER : Récupérer les informations de l'organisateur si disponibles
            ...
            <div class="event-card <?php echo $evenement['prix'] > 0 ? 'featured-event' : ''; ?>">
                ...
                <div class="event-content">
                    ...
                    <!-- AJOUTER : Affichage de l'organisateur -->
        ...
        <div class="history-container">
            <div class="history-form-container">
                <div class="history-card">
                    <div class="history-header">
                        ...
                        <p class="history-description">
                            <?php if(isset($_SESSION['user_id'])): ?>
                                ...
                                Consultez vos événements ou entrez un email pour vérifier.
                            <?php else: ?>
                    ...
                    <form id="historyForm" class="history-form" novalidate>
                        <?php if(!isset($_SESSION['user_id'])): ?>
                        <!-- Afficher le champ email seulement si non connecté -->
                        ...
                        <button type="submit" class="btn-history">
                            <span class="btn-icon">🔍</span>
                            <?php echo isset($_SESSION['user_id']) ? 'VOIR MON HISTORIQUE' : 'CONSULTER L\'HISTORIQUE'; ?>
                        </button>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('historyForm').addEventListener('submit', function(e) {
            ...
            // AJOUTER : Préparer les données selon si l'utilisateur est connecté ou non
            let formData = new FormData();
            
            <?php if(isset($_SESSION['user_id'])): ?>
                // Utilisateur connecté - pas besoin d'email
                formData.append('user_id', '<?php echo $_SESSION['user_id']; ?>');
            <?php else: ?>
                // Utilisateur non connecté - utiliser l'email
            ...
            // Requête AJAX - modification pour gérer les deux modes
                ...
                html += `
                    <div class="history-event-card ${isPast ? 'past-event' : 'upcoming-event'}">
                        ...
                        <div class="history-event-content">
                            <h4>${event.nom}</h4>
                            <!-- AJOUTER : Afficher l'organisateur -->
    ...
    <style>
        /* AJOUTER : Style pour l'organisateur dans les cartes d'événements */
        .event-organizer {
            color: #00ccff;
            font-size: 0.7rem;
