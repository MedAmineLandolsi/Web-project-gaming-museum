...
class MembreController {
    ...
    public function indexFront() {
        ...
        ob_start();
        include dirname(__DIR__) . '/view/frontoffice/membres/index.php';
    ...
    public function showFront($id) {
        ...
        if($this->membreModel->read_single()) {
            ...
            ob_start();
            include dirname(__DIR__) . '/view/frontoffice/membres/show.php';
            $content = ob_get_clean();
            include dirname(__DIR__) . '/view/frontoffice/layout.php';
        } else {
    ...
    public function indexBack() {
        ...
        ob_start();
        include dirname(__DIR__) . '/view/backoffice/membres/index.php';
        $content = ob_get_clean();
    ...
    public function showBack($id) {
        ...
        if($this->membreModel->read_single()) {
            ...
            ob_start();
            include dirname(__DIR__) . '/view/backoffice/membres/show.php';
            $content = ob_get_clean();
            include dirname(__DIR__) . '/view/backoffice/layout.php';
        } else {
    ...
    public function create() {
        ...
        ob_start();
        include dirname(__DIR__) . '/view/backoffice/membres/create.php';
        $content = ob_get_clean();
        include dirname(__DIR__) . '/view/backoffice/layout.php';
    }
    ...
    public function edit($id) {
        ...
        if($this->membreModel->read_single()) {
            ...
            ob_start();
            include dirname(__DIR__) . '/view/backoffice/membres/edit.php';
            $content = ob_get_clean();
            include dirname(__DIR__) . '/view/backoffice/layout.php';
        } else {
            $this->showError("Membre non trouvé", true);
