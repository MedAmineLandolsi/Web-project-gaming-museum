...
<head>
    ...
    <title>Connexion - RetroGame Hub</title>
        ...
        <div class="container">
            <div class="page-header">
                <h2 class="page-header-title">
                    ...
                    <a href="register.php" style="text-decoration: none;">INSCRIPTION</a>
                </h2>
                        ...
                        <div class="section text-center">
                            ...
                            <form id="loginForm" method="POST">
                                ...
                                <p class="mb-0 mt-3 text-center">
                                    <a href="register.php" class="link signup-link">Pas encore inscrit ? <span>S'INSCRIRE &gt;</span></a>
                                </p>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        ...
        function validateLoginForm() {
            ...
            if (!username.value.trim()) {
                showError(username, 'Email ou nom d\'utilisateur requis');
                isValid = false;
            } else {
                clearError(username);
            }
            ...
            if (validateLoginForm()) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        showError(document.getElementById('loginUsername'), data.message);
        ...
        // Redirection vers register.php si on clique sur le bouton d'inscription
        document.querySelector('a[href="register.php"]').addEventListener('click', function(e) {
            e.preventDefault();
            window.location.href = 'register.php';
        });
    </script>
