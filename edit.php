        ...
        <div class="edit-container">
            ...
            <div class="event-info">
                <div class="info-item">
                    ...
                    <div class="info-value"><?php echo date('d/m/Y', strtotime($evenement->date_creation)); ?></div>
                </div>
                <div class="info-item">
                    <div class="info-label">STATUT</div>
                    <div class="info-value" style="color: var(--primary-green)">ACTIF</div>
                </div>
                <div class="info-item">
                    <div class="info-label">PLACES RESTANTES</div>
                    <div class="info-value" style="color: var(--secondary-purple)">
                        <?php 
                        $participationsCount = $evenement->countParticipations ? $evenement->countParticipations() : 0;
