...
class Reclamation {
    ...
    public function getAll() {
        $query = "SELECT r.*, u.username AS user_username, u.email AS user_email
    ...
    public function add($reclamation) {
        $query = "INSERT INTO " . $this->table_name . " 
                  SET user_id=:user_id, nomClient=:nomClient, emailClient=:emailClient, 
        ...
        $userId = $reclamation['user_id'] ?? null;
