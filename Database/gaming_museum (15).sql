...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2025 at 08:29 PM
...
CREATE TABLE `commande` (
  ...
  `statut` enum('pending','processing','completed','cancelled','shipped','delivered') DEFAULT 'pending',
...
INSERT INTO `commande` (`ID`, `Produit_id`, `Total`, `quantity`, `Date`, `user_id`, `statut`, `order_ref`, `shipping_name`, `shipping_email`, `shipping_phone`, `shipping_address`, `shipping_city`, `shipping_zip`, `shipping_country`, `billing_name`, `billing_address`, `billing_city`, `billing_zip`, `billing_country`, `payment_method`, `notes`) VALUES
(41, 25, 40, 1, '2025-12-12', 16, 'delivered', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(42, 26, 10, 1, '2025-12-12', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(43, 25, 40, 1, '2025-12-12', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(44, 25, 80, 2, '2025-12-12', NULL, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(45, 24, 39.9, 1, '2025-12-13', 16, 'pending', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(46, 25, 40, 1, '2025-12-14', 16, 'cancelled', 'ORD-20251214-693F23FF2AB19', 'wissem', 'wissemhanachi666@gmail.com', '22677184', 'hay nazehe 1145', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL),
(47, 25, 40, 1, '2025-12-14', 16, 'pending', 'ORD-20251214-693F255DB6858', 'wissem', 'wissemhanachi666@gmail.com', '22677184', 'dwdwdwd', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL),
(48, 25, 40, 1, '2025-12-14', 16, 'pending', 'ORD-20251214-693F28C2DC589', 'wissem', 'wissemhanachi666@gmail.com', '22677184', 'hay nazehe 1145', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL),
(49, 25, 40, 1, '2025-12-14', 16, 'pending', 'ORD-20251214-693F291338D9F', 'wissem', 'wissemhanachi666@gmail.com', '22677184', 'hay nazehe 1145', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL),
(50, 25, 40, 1, '2025-12-14', 16, 'pending', 'ORD-20251214-693F2948BBC95', 'wissem', 'wissemhanachi666@gmail.com', '22677184', 'hay nazehe 1145', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL),
(51, 26, 10, 1, '2025-12-14', 16, 'pending', 'ORD-20251214-693F2ADBC81A8', 'wissem', 'wissemhanachi666@gmail.com', '22677184', 'hay nazehe 1145', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL),
(52, 25, 40, 1, '2025-12-14', 17, 'cancelled', 'ORD-20251214-693F307C85EE2', 'wissemm', 'wissem.hanachi@esprit.tn', '22677184', 'hay nazehe 1145', 'mhamdia', '1145', 'Tunisia', NULL, NULL, NULL, NULL, NULL, 'cash', NULL);
...
--
-- Table structure for table `communaute_membres`
--
...
INSERT INTO `game_screenshots` (`id`, `game_id`, `image_url`, `caption`, `sort_order`, `uploaded_at`) VALUES
(1, 27, 'game_27_screen_1.jpg', 'Geralt de Riv - Écran titre', 1, '2025-12-14 22:02:11'),
(2, 27, 'game_27_screen_2.jpg', 'Combat contre un monstre', 2, '2025-12-14 22:02:11'),
(3, 27, 'game_27_screen_3.jpg', 'Carte du monde - Velen', 3, '2025-12-14 22:02:11'),
(4, 27, 'game_27_screen_4.jpg', 'Scène avec Yennefer', 4, '2025-12-14 22:02:11'),
(5, 27, 'game_27_screen_5.jpg', 'Menu des compétences', 5, '2025-12-14 22:02:11'),
(6, 27, 'game_27_screen_6.jpg', 'Geralt de Riv - Écran titre', 6, '2025-12-14 22:02:11'),
(7, 25, 'game_25_screen_1.jpg', 'Geralt de Riv - Écran titre', 1, '2025-12-14 22:02:11'),
(8, 25, 'game_25_screen_2.jpg', 'Combat contre un monstre', 2, '2025-12-14 22:02:11'),
(9, 25, 'game_25_screen_3.jpg', 'Carte du monde - Velen', 3, '2025-12-14 22:02:11'),
(10, 25, 'game_25_screen_4.jpg', 'Scène avec Yennefer', 4, '2025-12-14 22:02:11'),
(11, 25, 'game_25_screen_5.jpg', 'Scène avec Yennefer', 5, '2025-12-14 22:02:11'),
(12, 25, 'game_25_screen_6.jpg', 'Menu des compétences', 6, '2025-12-14 22:02:11'),
(13, 24, 'game_24_screen_1.jpg', 'Geralt de Riv - Écran titre', 1, '2025-12-14 22:02:11'),
(14, 24, 'game_24_screen_2.jpg', 'Combat contre un monstre', 2, '2025-12-14 22:02:11'),
(15, 24, 'game_24_screen_3.jpg', 'Carte du monde - Velen', 3, '2025-12-14 22:02:11'),
(16, 24, 'game_24_screen_4.jpg', 'Scène avec Yennefer', 4, '2025-12-14 22:02:11'),
(17, 24, 'game_24_screen_5.jpg', 'Scène avec Yennefer', 5, '2025-12-14 22:02:11'),
(18, 24, 'game_24_screen_6.jpg', 'Menu des compétences', 6, '2025-12-14 22:02:11');
...
CREATE TABLE `jeux` (
  ...
  `rarity` enum('common','rare','very_rare','collector','museum_piece') DEFAULT 'common',
  `condition` enum('new','like_new','very_good','good','acceptable') DEFAULT 'very_good',
...
INSERT INTO `jeux` (`id`, `nom`, `description`, `prix`, `stock`, `categorie`, `image`, `trailer_url`, `rarity`, `condition`, `edition`, `estimated_value`, `collector_notes`) VALUES
(1, 'Clair Obscur: Expedition 33', 'Clair Obscur: Expedition 33 is a 2025 dark fantasy RPG where players lead a team in a Belle Époque-inspired world to stop the \"Gommage,\" a yearly event where a god-like entity, the Paintress, erases people by lowering their maximum age, leading to an annual death countdown. The game features a unique blend of classic turn-based combat with real-time action mechanics like dodging and parrying, deep character customization, exploration, and a somber yet hopeful narrative about humanity\'s fight for', 39.9, 100, 'RPG', '33.jpg', 'https://www.youtube.com/watch?v=ejgW-upPMgk', 'common', 'new', NULL, NULL, NULL),
(2, 'EAFC 26', 'EA Sports FC 26 is a community-driven football game with overhauled gameplay, featuring Authentic (realistic Career Mode) and Competitive (faster Ultimate Team/Clubs) presets, new player Archetypes for deeper customization, live manager challenges, and expanded Ultimate Team modes with new Live Events and Evolution consumables like the \"Unbreakables\" series, focusing on deep realism, customization, and responsive gameplay. ', 59.9, 100, 'Sports', 'eafc.jpg', 'youtube.com/watch?v=TSi0iJYSQ24&vl=en', 'common', 'new', NULL, NULL, NULL),
(24, 'Arc Raiders', 'ARC Raiders is a 2025 third-person extraction shooter developed and published by Embark Studios for PlayStation 5, Windows and Xbox Series X/S. The gameplay is PvPvE and can be played in teams of thre', 39.9, 100, 'Looter Shooter', 'arc.jpg', 'https://www.youtube.com/watch?v=9slTF7NJ7UI', 'common', 'very_good', NULL, NULL, NULL),
(25, 'GRAND THEFT AUTO 5', 'Grand Theft Auto V is a 2013 action-adventure game developed by Rockstar North and published by Rockstar Games. It is the seventh main entry in the Grand Theft Auto series, following 2008\'s Grand Thef', 40, 94, 'Action', 'gta.jpg', 'https://www.youtube.com/watch?v=Bf38HiYPMiI', 'common', 'very_good', NULL, NULL, NULL),
(26, 'Fortnite', 'Fortnite is a 2017 online video game and game platform developed and released by Epic Games. It is available in seven distinct game mode versions that otherwise share the same general gameplay and game', 10, 99, 'Battle Royale', 'fort.jpg', 'https://www.youtube.com/watch?v=X_zzh-g2a4M', 'common', 'very_good', NULL, NULL, NULL),
(27, 'The Witcher 3: Wild Hunt', 'The Witcher 3: Wild Hunt is a 2015 action role-playing game developed and published by CD Projekt. It is the sequel to the 2011 game The Witcher 2: Assassins of Kings and the third game in The Witcher video game series, played in an open world with a third-person perspective.', 39.99, 100, 'Open World', '693f3a83792cd_withcer.jpg', 'https://www.youtube.com/watch?v=c0i88t0Kacs', 'common', 'very_good', NULL, NULL, NULL);
...
(27, 'wissem', 'wissemhanachi666@gmail.com', '$2y$10$PaCvo56UtiMfa5wBrr1un.4Ywbz1J3zN98mgwcKh.nc56UllmVrzO', '', '', '', '2006-03-17', '', 'admin', 'active', NULL, NULL),
(28, 'wissemm', 'wissem.hanachi@esprit.tn', '$2y$10$a/F.5Z9td5k7/51Q7v6bx.0TifjUszZ0WJqdgno2dI.7otHQr9KoC', '', '', '', '2003-07-04', '', 'user', 'active', NULL, NULL);
...
--
-- Indexes for table `communaute_membres`
--
...
--
-- AUTO_INCREMENT for table `communaute`
--
ALTER TABLE `communaute`
...
ALTER TABLE `commande`
  ...
  ADD CONSTRAINT `fk_jeux_id` FOREIGN KEY (`Produit_id`) REFERENCES `jeux` (`id`);
...
--
-- Constraints for table `communaute`
--
ALTER TABLE `communaute`
...
--
-- Constraints for table `communaute_membres`
--
ALTER TABLE `communaute_membres`
...
--
ALTER TABLE `game_screenshots`
  ADD CONSTRAINT `game_screenshots_ibfk_1` FOREIGN KEY (`game_id`) REFERENCES `jeux` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `order_items_ibfk_1` FOREIGN KEY (`commande_id`) REFERENCES `commande` (`ID`) ON DELETE CASCADE,
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`jeu_id`) REFERENCES `jeux` (`id`) ON DELETE CASCADE;
